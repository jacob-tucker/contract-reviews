...
pub contract interface NonFungibleToken {
    ...
    // Event that emitted when a token is transferred to another collection.
    //
    // It indicates the owner of the collection that it was withdrawn from
    // and deposited to.
    //
    ...
    pub resource Collection: Provider, Receiver, CollectionPublic {
        ...
        pub fun transfer(id: UInt64, recipient: &{NonFungibleToken.CollectionPublic}) {
            post {
                self.ownedNFTs[id] == nil: "You didn't transfer the intended NFT."
                recipient.borrowNFT(id: id) != nil: "You didn't transfer the intended NFT."
            }
        }
